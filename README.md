...
- **ignore** — not a question at all: idle shell/REPL prompts (`PS C:\…>`,
  `user@host:~# puppetty
...
, `❯`, `>>>`) are skipped silently — no events, no feed
  noise. Built-in rules cover the common shells; add your own for exotic
  prompts.
